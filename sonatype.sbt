...
sonatypeProfileName := "ai.tripl.arc-mongodb-pipeline-plugin"
...
scmInfo := Some(
  ScmInfo(
    url("https://github.com/tripl-ai/arc-mongodb-pipeline-plugin"),
    "scm:git@github.com:tripl-ai/arc-mongodb-pipeline-plugin.git"
  )
)
developers := List(
